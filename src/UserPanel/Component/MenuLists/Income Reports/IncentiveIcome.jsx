...
const IncentiveIncome = () => {
  const [showModal, setShowModal] = useState(false);
  const [selectedRecord, setSelectedRecord] = useState(null);
  const [search, setSearch] = useState("");

  // STATIC INCENTIVE INCOME RECORDS
  const incentiveData = [
    {
      id: "INC001",
      member: "Rahul Sharma",
      incentiveType: "Level Bonus",
      amount: "₹1,000",
      date: "12-12-2025",
      remark: "Level 1 Achievement",
    },
    {
      id: "INC002",
      member: "Amit Patel",
  ...
  return (
    <div className="min-h-screen">
      ...
      <h1 className="text-center pt-20 text-xl font-bold">Incentive Income Report</h1>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    {item.incentiveType} • {item.amount} • {item.date}
                  </p>
                </div>
              </div>
        ...
        <div className="fixed inset-0 bg-black/40 flex justify-center items-center p-4">
          <div className="bg-white w-full max-w-sm rounded-xl shadow-xl p-5 relative">
            ...
            <h2 className="text-lg font-bold text-center mb-4">
              Incentive Income Details
            </h2>

            <div className="bg-white shadow-md border p-4 rounded-lg grid gap-2 text-sm">
              <p><strong>Incentive ID:</strong> {selectedRecord.id}</p>
              <p><strong>Member:</strong> {selectedRecord.member}</p>
              <p><strong>Incentive Type:</strong> {selectedRecord.incentiveType}</p>
...
export default IncentiveIncome;
